...
В описании запросов и ответов следующие обозначение:
* П - пробел
...
`КОЛИЧЕСТВО_БАЙТ` это число - количество байт, которая занимает строка `СОДЕРЖИМОЕ_КАТАЛОГА` в следующем ответе.
